...
/* Includes ---------------------------------------------------------------- */
#include <Gesture_Recognization_CV_inferencing.h>
...
void loop()
{
    ...
    while(stop_inferencing == false) {
        ...
        for (size_t ix = 0; ix < EI_CLASSIFIER_LABEL_COUNT; ix++) {
          ...
          if (result.classification[0].value > 0.6 && result.classification[0].label == "go")
          {
            digitalWrite(LEDG, LOW); 
            delay(500);
            digitalWrite(LEDG, HIGH); 
          }
          else if (result.classification[1].value > 0.6 && result.classification[1].label == "left")
          {
          ...
          else if (result.classification[2].value > 0.6 && result.classification[2].label == "right")
          {
          ...
          else if (result.classification[3].value > 0.6 && result.classification[3].label == "stop")
          {
            digitalWrite(LEDR, LOW);
            delay(500);
            digitalWrite(LEDR, HIGH); 
